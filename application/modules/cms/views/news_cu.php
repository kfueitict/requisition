...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('cms/news') ?>"><i class="fa fa-users"></i>News</a></li>
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <button type="button"
                        onclick="window.location.href='<?php echo base_url('cms/news')?>'" class="btn btn-info pull-right">Back</button>
            </div><!-- /.box-header -->
            <!-- form start -->
...
<script>
    CKEDITOR.replace('description', {toolbar : 'Full',filebrowserImageUploadUrl : BASE_URL+'/cms/news/upload'});
</script>
<script>
