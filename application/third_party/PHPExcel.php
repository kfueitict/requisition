...
class PHPExcelStyling {
    ...
    function alignment($horizontal=PHPExcel_Style_Alignment::HORIZONTAL_CENTER,$vertical=PHPExcel_Style_Alignment::VERTICAL_CENTER)
    {
    ...
    function borders($borderType=borderTypes::allborders,$style=PHPExcel_Style_Border::BORDER_THIN,$color=PHPExcel_Style_Color::COLOR_BLACK)
    {
    ...
    function fill($type=PHPExcel_Style_Fill::FILL_GRADIENT_LINEAR,$rotation=90,$startcolor='A0A0A0',$endcolor='FFFFFF')
    {
        return array(
            'fill' => array(
                'type' => $type,
